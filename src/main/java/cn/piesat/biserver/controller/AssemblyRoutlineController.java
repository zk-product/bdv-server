 ...
 */
@RestController
@RequestMapping("/assemblyRoutline")
public class AssemblyRoutlineController extends AbstractAssemblyController<AssemblyRoutlineEntity> {

    @Autowired
    @Qualifier("assemblyRoutlineImpl")
    ...
    @Override
    @RequestMapping("/updateRoutlineAssemblyDataById")
    public Response updateAssemblyDataById(@RequestBody AssemblyRoutlineEntity routlineEntity) {
        Response response = Response.getInstance();
        boolean b = iAssemblyCurrency.updataAssemblyDataById(routlineEntity);
        if (b) {
